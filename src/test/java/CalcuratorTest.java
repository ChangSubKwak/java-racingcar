...
public class CalcuratorTest {
    ...
    @Test
    @DisplayName("divide메서드를 이용하여 8을 0으로 나누면 정상적으로 익셉쳔처리 메세지가 출력되고 0을 리턴한다")
    void divideTest(){
    ...
    void spaceTest(){
        String str = "1 + 3";
        String[] result = {"1" , "+", "3"};
        assertThat(result).isEqualTo(calculator.space(str));
    ...
    void calTest(){
        String str = "2 + 3 * 4 / 2";
        String[] result = calculator.space(str);
